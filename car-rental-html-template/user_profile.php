  ...
  <form method="post">
    ...
    <div class="background">
        <div class="form">
            ...
            <input type="email" placeholder="Email" class="input" name="email" value="<?php echo $r->email; ?>">
            <input type="password" placeholder="Password" class="input" name="password" value="<?php echo $r->password; ?>">
        <div class="gender">
          ...
          <button type="submit" class="btn btn-default" name="save_change">Save Change</button>
